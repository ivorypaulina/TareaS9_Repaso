...
public class Cafeteria implements CrudPedido {
    ...
    public void registrarPedido(String correo, double consumo) {
        ...
        if (cliente == null) {
            System.out.println("No se puede registrar el pedido. Cliente inexistente.");
            return;
        }
    ...
    public void mejorCliente() {
        ...
        System.out.println("Mejor cliente: " + mejorCodigo + " Consumo: " + mayorConsumo);
    }
    ...
    public void mostrarPedidos() {
        ...
        for (Map.Entry<String, Double> pedido : mapaPedidos.entrySet()) {
            System.out.println("Código Cliente: " + pedido.getKey() + " Consumo: " + pedido.getValue());
        }
    }
}